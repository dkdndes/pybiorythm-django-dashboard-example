...
def test_real_correlation_heatmap():
    ...
    for i in range(100):
        ...
        data.append({"physical": physical, "emotional": emotional, "intellectual": intellectual})
    ...
    fig.add_trace(
        go.Heatmap(
            ...
            showscale=True,
            colorbar=dict(title="Correlation Coefficient", tickmode="linear", tick0=-1, dtick=0.5),
        )
    )
