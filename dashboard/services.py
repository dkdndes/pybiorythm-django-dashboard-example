...
class PyBiorythmAPIClient:
    ...
    def get_person_statistics(self, person_id: int) -> dict[str, Any] | None:
    ...
    def calculate_biorhythm(
        self, person_id: int, days: int = 365, target_date: date | None = None, notes: str = ""
    ) -> dict[str, Any] | None:
    ...
    def get_calculations(self, person_id: int | None = None) -> dict[str, Any] | None:
    ...
    def get_global_statistics(self) -> dict[str, Any] | None:
...
class CachedAPIClient:
    ...
    def get_people_cached(self, cache_key: str = "api_people_list") -> dict[str, Any] | None:
    ...
    def get_person_cached(self, person_id: int) -> dict[str, Any] | None:
    ...
    def get_person_statistics_cached(self, person_id: int) -> dict[str, Any] | None:
    ...
    def invalidate_person_cache(self, person_id: int):
        ...
        cache_keys = [f"api_person_{person_id}", f"api_person_stats_{person_id}", "api_people_list"]
    ...
    def get_biorhythm_data_fresh(
        ...
        return self.client.get_person_biorhythm_data(person_id, start_date, end_date, limit)
