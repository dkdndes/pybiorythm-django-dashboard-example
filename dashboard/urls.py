...
urlpatterns = [
    ...
    path(
        "charts/person/<int:person_id>/critical/", views.chart_critical_days, name="chart_critical"
    ),
    ...
    # Action endpoints
    path(
        "person/<int:person_id>/calculate/", views.calculate_biorhythm, name="calculate_biorhythm"
    ),
