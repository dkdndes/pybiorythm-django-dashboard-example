    ...
    if not critical_dates.empty:
        fig.add_trace(
            go.Scatter(
                ...
                name="Critical Days",
                marker=dict(
                    symbol="diamond", size=8, color="red", line=dict(color="darkred", width=1)
                ),
...
def create_cycle_distribution_chart(biorhythm_data: list[dict], person_name: str) -> str:
    ...
    fig.update_layout(
        title=dict(text=f"Biorhythm Cycle Distribution - {person_name}", x=0.5, font=dict(size=20)),
...
def create_critical_days_calendar(biorhythm_data: list[dict], person_name: str) -> str:
    ...
    fig.update_layout(
        title=dict(text=f"Critical Days Calendar - {person_name}", x=0.5, font=dict(size=20)),
...
def create_cycle_phase_chart(biorhythm_data: list[dict], person_name: str) -> str:
    ...
    fig.update_layout(
        title=dict(text=f"Current Cycle Phases - {person_name}", x=0.5, font=dict(size=20)),
        polar=dict(
...
def create_correlation_chart(biorhythm_data: list[dict], person_name: str) -> str:
    ...
    fig.update_layout(
        title=f"Biorhythm Cycle Correlation Matrix - {person_name}", height=400, width=500
    )
...
def create_statistics_summary_chart(statistics: dict[str, Any], person_name: str) -> str:
    ...
    fig.update_layout(
        title=dict(text=f"Critical Days Analysis - {person_name}", x=0.5, font=dict(size=20)),
